...
\begin{cdrfigure}[LBNF Work Breakdown Structure (WBS) to level 3]{lbnf-wbs}{LBNF Work Breakdown Structure (WBS) to level 3  \fixme{get update from Angel}}
...
\begin{cdrfigure}[LBNF organization]{lbnf-org}{LBNF organization \fixme{get update from Angel}}
