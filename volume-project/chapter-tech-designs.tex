...
WA105 has signed an MoU with the CERN Neutrino Platform to provide a large dual-phase \fixme{right?}
...
be provided on a similar timescale. This single-phase prototype is called \textit{ProtoDUNE}. Both will be exposed to charged-particle test 
...
milestones are defined for ProtoDUNE: %this single-phase prototype: 
...
risks for the construction of the first 10-kt module. The proposal for ProtoDUNE %the DUNE single-phase prototype 
