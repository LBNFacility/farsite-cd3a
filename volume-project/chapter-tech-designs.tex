...
A Beamline Measurement System (BLM) will be located in the region of the absorber. The BLM aims to measure the muon fluxes from hadron decay and is intended to monitor the beam profile on a spill-by-spill basis. %It will operate for the life of the experiment. % moved from ND section below
...
violation and mass hierarchy determination, as discussed in \volphys~\cite{design-doc-dune-physics}.  This optimization work is ongoing and may yield further improvements beyond those currently achieved. Engineering studies of the proposed horn designs and methods 
...
comprehensive prototyping effort. At this stage, the development of two options is a strength made possible by the merging of the worldwide neutrino community into DUNE.  The two detector
...
The \ktadj{10} reference design TPC is described in Chapter 4 of \voldune~\cite{design-doc-dune-det}.
Its active volume is 12\,m high, 14.5\,m wide and 
58\,m long, instrumented with anode plane assemblies (APAs), 
which are 6\,m high and 2.3\,m wide, and cathode plane assemblies (CPAs), 3\,m high by 2.3\,wide. 
Vertical stacks of
...
%The near detector will be complemented by a Beamline Measurement System (BLM) located in the region of the beam absorber at the downstream end of the decay region. The BLM aims to measure the muon fluxes from hadron decay and is intended to monitor the beam profile on a spill-by-spill basis. It will operate for the life of the experiment.
...
on the LArTPC technology, the viability of 
...
has been identified and summarized in \voldune~\cite{design-doc-dune-det}. Common solutions for DAQ, 
...
by 2021, the first 10-kt module will be based on the single-phase design using anode and cathode
plane assemblies (APAs and CPAs), described in Chapter 4 of \voldune~\cite{design-doc-dune-det}. 
...
concept is the \textit{reference design} 
...
a final design review will take place towards the beginning of 2019 and construction of the readout planes will 
commence in 2020, to be ready for first installation in 2021. 
...
$\sim$8$\times$8$\times$8\,m\textsuperscript{3} cryostat by October 2016 in the new EHN1 extension to house a dual-phase LArTPC.  %it is foreseen that 
On a similar timescale, it is planned to provide a second large cryostat to house a single-phase LArTPC; this prototype detector is called \textit{ProtoDUNE}. Both will be exposed to charged-particle test 
beam spanning a range of particle types and energies.   

The DUNE collaboration will instrument ProtoDUNE  %one of these cryostats 
with an arrangement 
...
shared between the DOE project and international partners. ProtoDUNE %The CERN prototype 
thus  provides the opportunity for the production sites to validate the manufacturing 
procedure ahead of large-scale production for the far detector. Three major operational 
milestones are defined for ProtoDUNE:  
...
risks for the construction of the first 10-kt module. The proposal for ProtoDUNE 
was presented to the CERN SPS Scientific Committee in June 2015 and is awaiting formal approval at their 
...
DUNE is responsible for construction and operation of the single-phase ProtoDUNE
detector at CERN and will appoint a management team with responsibility for this effort.
Management of the WA105 effort is not currently a DUNE responsibility, but the two management 
teams are expected to work together to adopt common technical solutions.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Strategy for the Second and Subsequent \ktadj{10} Far Detector Modules}
...
of the design for the second module in 2020; 
...
\begin{itemize}
\item  the ability to adequately constrain the systematic errors in the DUNE LBL oscillation 
analysis; this requires the capability to precisely measure exclusive neutrino
interactions

\item the self-contained non-oscillation 
...
7 of \voldune~\cite{design-doc-dune-det}. 
...
given in Section 6.1.1 of \volphys~\cite{design-doc-dune-physics}. The large samples of neutrino 
